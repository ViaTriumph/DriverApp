...
import com.example.pruthvi.driverapp.R;
import com.example.pruthvi.driverapp.SignUpActivity;
...
public class HomeScreenActivity extends AppCompatActivity {
    ...
    public String TAG=HomeScreenActivity.class.getSimpleName();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Query query=mReference.child("cabDrivers").orderByChild("driverName").equalTo(user.getDisplayName());
                            ...
                            query.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if(!dataSnapshot.exists()){
                                        ...
                                        Toast.makeText(HomeScreenActivity.this, "User Signed In", Toast.LENGTH_SHORT).show();
                                        DatabaseReference mRef=mReference.child("cabDrivers").child(user.getDisplayName());
                                        Log.d(TAG, "onDataChange: "+user.getPhotoUrl());
                                        mRef.child("photoUrl").setValue(user.getPhotoUrl().toString());
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(this,
                new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(fromToolbar) {
                            Toast.makeText(HomeScreenActivity.this, "Not registered!", Toast.LENGTH_LONG).show();
                        }else{
     ...
     *
     * @param item
     * @return option selected from toolbar.
     */
    @Override
